...
public class RandomUserForm extends javax.swing.JFrame implements IObserver{
  ...
  // End of variables declaration//GEN-END:variables
    ...
    @Override
    public void dataReader(RandomUser rand) {
        textFirstName.setText(rand.getFirstName());
    textLastName.setText(rand.getLastName());
    textStreet.setText(rand.getStreet());
    textCity.setText(rand.getCity());
    textEmail.setText(rand.getEmail());
    }
